...
class AdaptiveGridSampler(BasicGridSampler):
    def __init__(self, image=None, image_size=None, patch_size=None, patch_overlap=None, min_overlap=None):
...
class ChunkedGridSampler:
    def __init__(self, image=None, image_size=None, patch_size=None, patch_overlap=None, chunk_size=None):
        self.image = image
...
class ResizeSampler(Dataset):
    ...
    def sanity_check(self):
        if len(self.sampler) != len(self.resized_sampler):
            raise RuntimeError("Lengths of sampler ({}) and resized_sampler ({}) do not match.".format(len(self.sampler), len(self.resized_sampler)))
